...
private fun CalculateCoffeePrice(
    ...
    val SHOT_MODIFIER = 1.2
    val SIZE_MODIFIER = 1.1
    val ICE_MODIFIER = 1.05
    ...
    if (iceNumber == 0 && selectedTemperature != "Hot") {
        coffeePrice = coffeePrice * ICE_MODIFIER
    }
    coffeePrice = coffeePrice * countSelectAmount
    return coffeePrice
}
